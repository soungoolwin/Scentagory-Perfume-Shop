<template>
    <div>
        ...
        <div
            v-show="isMenuOpen"
            class="fixed inset-0 bg-[#290E11] bg-opacity-95 z-50"
        >
            <div class="container mx-auto p-4 flex flex-col">
                ...
                <ul
                    class="flex flex-col justify-center flex-grow space-y-4 mt-[40px]"
                >
                    <li @click="toggleMenu" class="flex justify-between">
                        <div class="flex">
                            <svg
                                ...
                                stroke-width="1.5"
                                stroke="currentColor"
                                class="w-6 h-6 text-white ml-3 mr-4"
                            >
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                    ...
                    <li @click="toggleMenu" class="flex justify-between pt-3">
                        <div class="flex">
                            <svg
                                ...
                                stroke-width="1.5"
                                stroke="currentColor"
                                class="w-6 h-6 ml-3 mr-4 text-white"
                            >
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
